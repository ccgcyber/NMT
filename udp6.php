...
<div id="wrapper3">
	<div id="portfolio">
		<div class="column1">
				<a href="udp6_time.php" class="button button-small">TIME</a><br> 
				<p>Time based analysis</p>
		</div>
               <div class="column3">
                                <a href="udp6_hop.php" class="button button-small">HLIM</a><br>    
...
<div id="wrapper3" align="center">
      ...
      <tbody>
        <?php
          ...
          <td> ".$row['hoplimit']. "</td><td> ".$row['nextheaderinfo']. "</td><td> ".$row['payloadlength']. "</td></tr>";
          }
          $conn->close();
        ?>
      </tbody>
