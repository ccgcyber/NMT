...
/usr/sbin/tcpdump -i eth0 -vv -c 10 ip6 > ipv6
...
paste timeudp sourceip66 destip6 hoplimit nextheaderinfo payloadlength > udp6
...
CREATE TABLE udpip6( Timestamp VARCHAR(30), Source_ip VARCHAR(30), Des_ip VARCHAR(30),hoplimit VARCHAR(30), nextheaderinfo VARCHAR(30),payloadlength VARCHAR(30)); 
