...
<div id="header" class="container">
                ...
                <div id="menu">
                        <ul>
                                ...
                                <li><a href="logout.php" accesskey="1" title=""><font size=5>LOGOUT</font></a></li>
                        </ul>
                </div>
</div>
<div id="wrapper3" align="center">
           <form name="form16" method="POST" action="tabudp.php">
            <?php
                session_start();
                ...
                echo $t1;
                echo $t2;
                $query="Select DISTINCT Source_IpAddress from udp WHERE Time_Stamp>='$t1' AND Time_Stamp<='$t2'";
