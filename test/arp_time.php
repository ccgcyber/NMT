...
<div id="header" class="container">
	...
	<div id="menu">
		<ul>
            ...
            <li><a href="logout.php" accesskey="6" title=""><font size=5>LOGOUT</font></a></li>    
    </ul>
	</div>
</div>
<div id="wrapper3" align="center">
  <form name="form1" method="post" action="sourcearp.php">
    ...
    <?php
                ...
                $query="Select DISTINCT Time_Stamp FROM arp";
