...
<div id="wrapper3" align="center"><br>
          <form name="form2" method="post" action="rescr.php">
                          <h2 align="center">First IP</h2>
                <input type="text" name="ip1" class="text"></input><br><br>
                        <h2 align="center">Second IP</h2>
                <input type="text" name="ip2" class="text"></input><br><br>
                <h2 align="center">Select Port</h2>
                <select name="port">
